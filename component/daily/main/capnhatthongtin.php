 ...
 <div class="content_tab-list-item ">
    ...
    <div class="content-card">
        <div class="content-cart-left">
            ...
            <p class="content-cart-left-info">Nguyễn Bá Khoa</p>
        ...
        <div class="content-cart-right">
            ...
            <div class="content-cart-right-Information-item">
                ...
                <input type="text" placeholder="0929084423">
                <p>Thay đổi</p>
            </div>
            <div class="content-cart-right-Information-item">
                <label >Email</label>
                <input type="text" placeholder="Abc@123456">
                <p>Thay đổi</p>
            </div>
            <div class="content-cart-right-Information-item">
            ...
            <div class="content-cart-right-Information-item">
                ...
                <input type="text" placeholder="Nguyễn Bá Khoa">
                <p>Thay đổi</p>
            </div>
            <div class="content-cart-right-Information-item">
            ...
            <div class="content-cart-right-Information-item">
                <label >Địa chỉ</label>
                <input type="text" placeholder="02 Thanh sơn, Thanh bình">
                <p>Thay đổi</p>
            </div>
            <div class="content-cart-right-Information-item">
